...
['월', '화', '수', '목']
*/
console.log("============================TODO: 배열 중간 원소 접근 실습");
// TODO: 배열 중간 원소 접근 실습
// 변수 numbers에 100, 200, 300, 400, 500을 담은 배열을 할당하고 출력한다
// 세 번째 원소를 출력한다
// 네 번째 원소를 350으로 변경하고 배열을 출력한다
let numbers_mid = [100, 200, 300, 400, 500];
console.log(numbers_mid[2]);
numbers_mid.splice(3, 1, "340");
console.log(numbers_mid[3]);
/* 출력 결과
[100, 200, 300, 400, 500]
300
[100, 200, 300, 350, 500]
...
[5, 25, 15, 20]
*/
console.log("============================TODO: 배열 원소 수정 메서드 실습");
...
*/
console.log("============================TODO: 배열 앞뒤 추가 제거 실습");
// TODO: 배열 앞뒤 추가 제거 실습
...
let del_Z = letters.pop([letters.length - 1]);
console.log(del_Z);
console.log(letters);
/* 출력 결과
['A', 'B']
...
[10, 20]
*/
console.log("============================TODO: 새로운 배열 만들기");
// TODO: 새로운 배열 만들기
// 변수 numbers에 1, 2, 3을 담은 배열을 할당하고 출력한다
let scores_newarr = [1, 2, 3];
console.log(scores_newarr);
// 배열의 반복문을 활용해서 변수 newNumbers에 numbers 배열의 각 원소에 2를 곱한 값을 담은 배열을 할당하고 출력한다
let newNumbers = [];
scores_newarr.forEach((arr) => {
  newNumbers.push(arr * 2);
});
...
let newNumbers_2 = [];
numbers_2.forEach((arr) => {
  if (arr % 2 === 0) {
    newNumbers_2.push(arr);
  }
});
...
let person_Del = { name: "이민수", age: 35, city: "부산" };
// 객체의 모든 키를 배열로 출력한다
console.log(Object.keys(person_Del));
// 객체의 모든 값을 배열로 출력한다
console.log(Object.values(person_Del));

// 객체의 모든 [키, 값] 쌍을 배열로 출력한다
console.log(Object.entries(person_Del));
/* 출력 결과
['name', 'age', 'city']
['이민수', 35, '부산']
[['name', '이민수'], ['age', 35], ['city', '부산']]
*/
console.log("============================TODO: 배열과 객체 혼합 1");
// TODO: 배열과 객체 혼합 1
